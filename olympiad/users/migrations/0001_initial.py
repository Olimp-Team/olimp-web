    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                to='main.classroom', verbose_name='Класс ученика')),
                ('classroom_guide',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='classroom_teachers', to='main.classroom')),
                ('groups', models.ManyToManyField(blank=True,
                                                  help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.',
                                                  related_name='user_set', related_query_name='user', to='auth.group',
                                                  verbose_name='groups')),
                ('post_job_teacher',
                 models.ManyToManyField(blank=True, to='main.post', verbose_name='Должность учителя')),
                ('subject',
                 models.ManyToManyField(blank=True, to='main.subject', verbose_name='Какой предмет ведёт учитель')),

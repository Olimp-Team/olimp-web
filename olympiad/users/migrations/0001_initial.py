    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('М', 'Male'), ('Ж', 'Womens')], default='М', max_length=2, verbose_name='Пол учителя')),
                ...
                ('classroom_guide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classroom_teachers', to='main.classroom')),

...
urlpatterns = [
    ...
    path('result-list-olympiad/', result_list_olympiad, name='result-list_olympiad'),
    path('list-olympiad/', list_olympiad, name='list_olympiad'),
    path('result/<int:olymp_id>', result, name='result'),
    path('delete/olympiad/<int:Olympiad_id>', olympiad_remove, name='olympiad_remove'),

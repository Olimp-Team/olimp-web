    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.category', verbose_name='Категория олимпиады')),
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.levelolympiad', verbose_name='Название уровня')),
